...
describe('parseENSAddress', () => {
  it('test cases', () => {
    ...
    expect(parseENSAddress('sangbejo19.eth/')).toEqual({ ensName: 'sangbejo19.eth', ensPath: '/' })
    ...
    expect(parseENSAddress('must.sangbejo19.eth')).toEqual({ ensName: 'must.sangbejo19.eth', ensPath: undefined })
